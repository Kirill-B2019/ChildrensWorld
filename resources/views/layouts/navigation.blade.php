<nav class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="mr-4 flex items-center overflow-hidden rounded-md border border-gray-300">
                    @foreach (['en' => 'EN', 'ru' => 'RU', 'kg' => 'KG'] as $lang => $label)
                        <a
                            href="{{ route('dashboard.locale', ['locale' => $lang]) }}"
                            class="px-2 py-1 text-xs font-semibold {{ app()->getLocale() === $lang ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700' }}"
                        >
                            {{ $label }}
                        </a>
                    @endforeach
    ...
    <div class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            <div class="px-4 pt-2 text-xs text-gray-500">Language</div>
            <div class="px-4 pb-2">
